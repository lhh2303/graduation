        ...
        },
        {
            ...
            children: [{
                ...
                },
                {
                    path: '/pet/bird',
                    name: 'bird',
                    component: resolve => require(['../components/pet/bird.vue'], resolve)
                }, {
                    path: '/pet/snake',
                    name: 'snake',
                    component: resolve => require(['../components/pet/snake.vue'], resolve)
                },
                {
                    path: '/pet/test',
                    name: 'test',
                    component: resolve => require(['../components/pet/test.vue'], resolve)
                },
                {
                    path: '/customer/index',
                    name: 'allCustomer',
