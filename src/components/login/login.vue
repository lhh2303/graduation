  ...
  <div class="box">
    <el-row type="flex" :style="conHeight" align="middle">
      <el-col :lg="{span:12, offset:12}" :md="{span:24}">
        <el-form :model="loginform" label-position="right" label-width="100px" class="login-form" :rules="rules"
          ref="loginform">
          ...
          <el-form-item prop="code" label="验证码:">
            <el-input type="text" v-model="loginform.code" size="small" class="input" style="margin-right:20px">
            </el-input>
              ...
              _this.axios
                ...
                .then(res => {
                  if (res.data.meta.status == 200) {
                    ...
                    const errStatement = res.data.msg
                    this.$message.error(`${errStatement}`);
                    _this.generatedCode();
                    _this.$nextTick(() => {
